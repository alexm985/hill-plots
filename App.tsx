        ...
        <div className="max-w-[1300px] mx-auto px-6">
            ...
            <div className="pt-12 border-t border-white/5">
                <div className="flex justify-center space-x-10 mb-10">
                    <a href="#" aria-label="Visit our Facebook page" className="text-[#A7B7B3] hover:text-[#0097b2] transition-colors text-2xl rounded-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0097b2] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0E1A1A]"><i className="fab fa-facebook-f" aria-hidden="true"></i></a>
                    <a href="#" aria-label="Visit our Instagram page" className="text-[#A7B7B3] hover:text-[#0097b2] transition-colors text-2xl rounded-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0097b2] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0E1A1A]"><i className="fab fa-instagram" aria-hidden="true"></i></a>
                    <a href="https://www.youtube.com/@hillplots" aria-label="Visit our YouTube channel" target="_blank" rel="noopener noreferrer" className="text-[#A7B7B3] hover:text-[#0097b2] transition-colors text-2xl rounded-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0097b2] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0E1A1A]"><i className="fab fa-youtube" aria-hidden="true"></i></a>
                </div>
