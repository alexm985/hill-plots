        ...
        <div className="max-w-[1300px] mx-auto px-6">
            ...
            <div className="pt-12 border-t border-white/5">
                <div className="flex justify-center space-x-10 mb-10">
                    ...
                    <a href="https://www.youtube.com/@hillplots" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-[#A7B7B3] hover:text-[#0097b2] transition-colors text-2xl"><i className="fab fa-youtube" aria-hidden="true"></i></a>
                </div>
