      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-8 bg-[#142626] p-8 md:p-12 border border-white/5 rounded-[10px] shadow-2xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="group">
              <label htmlFor="full-name" className="block text-[11px] font-bold uppercase tracking-[3px] text-[#C9A24D] mb-3">Full Name</label>
              <input
                id="full-name"
                type="text"
                required
            ...
            <div className="group">
              <label htmlFor="phone-number" className="block text-[11px] font-bold uppercase tracking-[3px] text-[#C9A24D] mb-3">Phone Number</label>
              <input
                id="phone-number"
                type="tel"
                required
          ...
          <div>
            <label htmlFor="plot-interest" className="block text-[11px] font-bold uppercase tracking-[3px] text-[#C9A24D] mb-3">Plot Interest</label>
          ...
          <div>
            <label htmlFor="your-message" className="block text-[11px] font-bold uppercase tracking-[3px] text-[#C9A24D] mb-3">Your Message</label>
            <textarea
              id="your-message"
              rows={4}
