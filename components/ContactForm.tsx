      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8">
        ...
        <div className="mt-16 pt-16 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="flex items-center space-x-10">
                <a href="#" aria-label="Visit our Facebook page" className="text-[#A7B7B3] hover:text-[#0097b2] transition-colors text-lg"><i className="fab fa-facebook-f"></i></a>
                <a href="#" aria-label="Visit our Instagram profile" className="text-[#A7B7B3] hover:text-[#0097b2] transition-colors text-lg"><i className="fab fa-instagram"></i></a>
                <a href="https://www.youtube.com/@hillplots" aria-label="Visit our YouTube channel" target="_blank" rel="noopener noreferrer" className="text-[#A7B7B3] hover:text-[#0097b2] transition-colors text-lg"><i className="fab fa-youtube"></i></a>
            </div>
