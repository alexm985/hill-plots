          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-16">
            <div className="flex flex-col">
              ...
              <div className="space-y-6">
                {error && (
                  <div role="alert" className="text-red-500 text-sm font-bold bg-red-500/10 border border-red-500/20 p-3 rounded-[10px]">
                    {error}
                  </div>
                )}
                <div>
                ...
                <div>
                  <label htmlFor="side-depth" className="block mb-2 text-[#A7B7B3] text-sm font-bold uppercase tracking-widest">Depth / Side (ft)</label>
                  <input 
                    id="side-depth"
                    type="number" 
                    value={width}
                ...
                <div>
                  <label htmlFor="sq-yard-rate" className="block mb-2 text-[#A7B7B3] text-sm font-bold uppercase tracking-widest">Rate per Sq. Yard (₹)</label>
                  <input 
                    id="sq-yard-rate"
                    type="number" 
                    value={price}
