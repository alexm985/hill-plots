        ...
        <div className="bg-[#0E1A1A] rounded-[10px] p-10 md:p-16 border border-white/5 max-w-[1000px] mx-auto shadow-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-16">
            <div className="flex flex-col">
              ...
              {error && (
                <div role="alert" className="text-red-500 text-sm mb-4 font-bold">
                  {error}
                </div>
              )}
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-[#142626] border border-white/10 p-4 text-white outline-none focus:border-[#0097b2] focus-visible:ring-2 focus-visible:ring-[#0097b2] focus-visible:outline-none transition-all font-serif rounded-[10px]"
                ...
                <button 
                  onClick={calculate}
                  className="w-full bg-[#0097b2] hover:bg-transparent border border-[#0097b2] text-white hover:text-[#0097b2] py-4 font-bold uppercase tracking-widest transition-all mt-4 rounded-[10px] focus-visible:ring-2 focus-visible:ring-[#0097b2] focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-[#142626]"
                >
                  Show Results
                </button>
              </div>
