          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-16">
            <div className="flex flex-col">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <label htmlFor="depth-side" className="block mb-2 text-[#A7B7B3] text-sm font-bold uppercase tracking-widest cursor-pointer">Depth / Side (ft)</label>
                  <input 
                    id="depth-side"
                    type="number" 
                    value={width}
                ...
                <div>
                  <label htmlFor="rate-price" className="block mb-2 text-[#A7B7B3] text-sm font-bold uppercase tracking-widest cursor-pointer">Rate per Sq. Yard (₹)</label>
                  <input 
                    id="rate-price"
                    type="number" 
                    value={price}
