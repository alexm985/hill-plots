        ...
        <div className="bg-[#0E1A1A] rounded-[10px] p-10 md:p-16 border border-white/5 max-w-[1000px] mx-auto shadow-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-16">
            <div className="flex flex-col">
              ...
              {error && (
                <div role="alert" className="mb-6 p-4 bg-red-500/10 border border-red-500/50 rounded-[10px] text-red-400 text-sm font-bold">
                  {error}
                </div>
              )}
              ...
              <div className="space-y-6">
                <div>
                  <label htmlFor="front-width" className="block mb-2 text-[#A7B7B3] text-sm font-bold uppercase tracking-widest cursor-pointer">Front Width (ft)</label>
                  <input 
                    id="front-width"
                    type="number" 
                    value={length}
                ...
                <div>
                  <label htmlFor="depth" className="block mb-2 text-[#A7B7B3] text-sm font-bold uppercase tracking-widest cursor-pointer">Depth / Side (ft)</label>
                  <input 
                    id="depth"
                    type="number" 
                    value={width}
                ...
                <div>
                  <label htmlFor="rate" className="block mb-2 text-[#A7B7B3] text-sm font-bold uppercase tracking-widest cursor-pointer">Rate per Sq. Yard (₹)</label>
                  <input 
                    id="rate"
                    type="number" 
                    value={price}
