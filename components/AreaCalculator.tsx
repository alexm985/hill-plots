          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-16">
            <div className="flex flex-col">
              ...
              <div className="space-y-6">
                {error && (
                  <div role="alert" className="bg-red-500/10 border border-red-500/50 text-red-400 p-4 rounded-[10px] text-sm font-serif italic">
                ...
                <div>
                  <label htmlFor="calc-depth-side" className="block mb-2 text-[#A7B7B3] text-sm font-bold uppercase tracking-widest">Depth / Side (ft)</label>
                  <input 
                    id="calc-depth-side"
                    type="number" 
                    value={width}
