          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-16">
            <div className="flex flex-col">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <label htmlFor="depth-width" className="block mb-2 text-[#A7B7B3] text-sm font-bold uppercase tracking-widest">Depth / Side (ft)</label>
                  <input 
                    id="depth-width"
                    type="number" 
                    value={width}
                ...
                {error && (
                  <div role="alert" className="text-[#ff4d4d] bg-[#ff4d4d]/10 border border-[#ff4d4d]/20 px-4 py-3 rounded-[10px] text-sm font-bold">
                    {error}
                  </div>
                )}
                <button 
