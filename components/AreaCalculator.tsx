        ...
        <div className="bg-[#0E1A1A] rounded-[10px] p-10 md:p-16 border border-white/5 max-w-[1000px] mx-auto shadow-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-16">
            <div className="flex flex-col">
              ...
              {error && (
                <div role="alert" className="bg-red-500/10 border border-red-500/20 text-red-500 p-4 rounded-[10px] mb-6 text-sm">
                  {error}
                </div>
              )}
              ...
              <div className="space-y-6">
                ...
                <div>
                  <label htmlFor="rateSqYard" className="block mb-2 text-[#A7B7B3] text-sm font-bold uppercase tracking-widest">Rate per Sq. Yard (₹)</label>
                  <input 
                    id="rateSqYard"
                    type="number" 
                    value={price}
