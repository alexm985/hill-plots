          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-16">
            <div className="flex flex-col">
              ...
              <div className="space-y-6">
                {error && (
                  <div role="alert" className="text-red-400 text-sm font-serif p-3 bg-red-900/20 border border-red-500/30 rounded-[10px]">
                    {error}
                  </div>
                )}
                <div>
                  <label htmlFor="calc-length" className="block mb-2 text-[#A7B7B3] text-sm font-bold uppercase tracking-widest cursor-pointer">Front Width (ft)</label>
                  <input 
                    id="calc-length"
                    type="number" 
                    value={length}
                    onChange={(e) => setLength(e.target.value)}
                    className="w-full bg-[#142626] border border-white/10 p-4 text-white outline-none focus:border-[#0097b2] focus-visible:ring-2 focus-visible:ring-[#0097b2] transition-all font-serif rounded-[10px]"
                    placeholder="Enter feet"
                  />
                </div>
                <div>
                  <label htmlFor="calc-width" className="block mb-2 text-[#A7B7B3] text-sm font-bold uppercase tracking-widest cursor-pointer">Depth / Side (ft)</label>
                  <input 
                    id="calc-width"
                    type="number" 
                    value={width}
                ...
                <div>
                  <label htmlFor="calc-price" className="block mb-2 text-[#A7B7B3] text-sm font-bold uppercase tracking-widest cursor-pointer">Rate per Sq. Yard (₹)</label>
                  <input 
                    id="calc-price"
                    type="number" 
                    value={price}
                ...
                <button 
                  onClick={calculate}
                  className="w-full bg-[#0097b2] hover:bg-transparent border border-[#0097b2] text-white hover:text-[#0097b2] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0097b2] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0E1A1A] py-4 font-bold uppercase tracking-widest transition-all mt-4 rounded-[10px]"
                >
                  Show Results
                </button>
              </div>
