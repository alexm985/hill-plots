          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-16">
            <div className="flex flex-col">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <label htmlFor="rate-yard" className="block mb-2 text-[#A7B7B3] text-sm font-bold uppercase tracking-widest">Rate per Sq. Yard (₹)</label>
                  <input 
                    id="rate-yard"
                    type="number" 
                    value={price}
                ...
                {error && (
                  <div role="alert" className="text-red-400 text-sm font-serif italic mt-2">
                    {error}
                  </div>
                )}
                <button 
