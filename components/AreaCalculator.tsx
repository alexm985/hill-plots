          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-16">
            <div className="flex flex-col">
              ...
              <div className="space-y-6">
                ...
                {error && (
                  <div role="alert" className="text-red-400 text-sm font-semibold mt-2">
                    {error}
                  </div>
                )}
                <button 
                  onClick={calculate}
                  className="w-full bg-[#0097b2] hover:bg-transparent border border-[#0097b2] text-white hover:text-[#0097b2] py-4 font-bold uppercase tracking-widest transition-all mt-4 rounded-[10px] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0097b2] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0E1A1A]"
                >
                  Show Results
                </button>
              </div>
