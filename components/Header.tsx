        ...
        <div className="max-w-[1300px] mx-auto px-6 sm:px-10">
          <div className="flex justify-between items-center">
            ...
            <div className="lg:hidden flex items-center">
              <button 
                className="text-white text-2xl focus:outline-none focus-visible:ring-2 focus-visible:ring-white rounded p-1"
        ...
        <div className="flex flex-col h-full pt-32 px-10 pb-10">
          ...
          <div className="mt-auto">
            ...
            <div className="flex justify-center space-x-8 mt-10">
              <a href="#" aria-label="Visit our Instagram page" className="text-white/40 hover:text-[#0097b2] text-xl transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0097b2] rounded p-1"><i className="fab fa-instagram" aria-hidden="true"></i></a>
              <a href="#" aria-label="Visit our Facebook page" className="text-white/40 hover:text-[#0097b2] text-xl transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0097b2] rounded p-1"><i className="fab fa-facebook-f" aria-hidden="true"></i></a>
              <a href="https://www.youtube.com/@hillplots" target="_blank" rel="noopener noreferrer" aria-label="Visit our YouTube channel" className="text-white/40 hover:text-[#0097b2] text-xl transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0097b2] rounded p-1"><i className="fab fa-youtube" aria-hidden="true"></i></a>
            </div>
          </div>
        </div>
      </div>
