        ...
        <div className="flex flex-col h-full pt-32 px-10 pb-10">
          ...
          <div className="mt-auto">
            ...
            <div className="flex justify-center space-x-8 mt-10">
              ...
              <a href="https://www.youtube.com/@hillplots" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-white/40 hover:text-[#0097b2] text-xl transition-colors"><i className="fab fa-youtube" aria-hidden="true"></i></a>
            </div>
          </div>
        </div>
      </div>
