        ...
        <div className="flex flex-col h-full pt-32 px-10 pb-10">
          ...
          <div className="mt-auto">
            ...
            <div className="flex justify-center space-x-8 mt-10">
              <a href="#" className="text-white/40 hover:text-[#0097b2] text-xl transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0097b2] rounded-sm" aria-label="Instagram"><i className="fab fa-instagram" aria-hidden="true"></i></a>
              <a href="#" className="text-white/40 hover:text-[#0097b2] text-xl transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0097b2] rounded-sm" aria-label="Facebook"><i className="fab fa-facebook-f" aria-hidden="true"></i></a>
              <a href="https://www.youtube.com/@hillplots" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-[#0097b2] text-xl transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0097b2] rounded-sm" aria-label="YouTube"><i className="fab fa-youtube" aria-hidden="true"></i></a>
            </div>
          </div>
        </div>
      </div>
