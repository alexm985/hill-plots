        ...
        <div className="flex flex-col h-full pt-32 px-10 pb-10">
          ...
          <div className="mt-auto">
            ...
            <div className="flex justify-center space-x-8 mt-10">
              <a href="#" aria-label="Visit our Instagram page" className="text-white/40 hover:text-[#0097b2] text-xl transition-colors rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0097b2] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0E1A1A]"><i className="fab fa-instagram" aria-hidden="true"></i></a>
              <a href="#" aria-label="Visit our Facebook page" className="text-white/40 hover:text-[#0097b2] text-xl transition-colors rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0097b2] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0E1A1A]"><i className="fab fa-facebook-f" aria-hidden="true"></i></a>
              <a href="https://www.youtube.com/@hillplots" target="_blank" rel="noopener noreferrer" aria-label="Visit our YouTube channel" className="text-white/40 hover:text-[#0097b2] text-xl transition-colors rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0097b2] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0E1A1A]"><i className="fab fa-youtube" aria-hidden="true"></i></a>
            </div>
          </div>
        </div>
      </div>
