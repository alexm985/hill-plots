        ...
        <div className="flex flex-col h-full pt-32 px-10 pb-10">
          ...
          <div className="mt-auto">
            ...
            <div className="flex justify-center space-x-8 mt-10">
              <a href="#" aria-label="Follow us on Instagram" className="text-white/40 hover:text-[#0097b2] text-xl transition-colors"><i className="fab fa-instagram"></i></a>
              <a href="#" aria-label="Follow us on Facebook" className="text-white/40 hover:text-[#0097b2] text-xl transition-colors"><i className="fab fa-facebook-f"></i></a>
              <a href="https://www.youtube.com/@hillplots" aria-label="Subscribe to our YouTube channel" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-[#0097b2] text-xl transition-colors"><i className="fab fa-youtube"></i></a>
            </div>
          </div>
        </div>
      </div>
