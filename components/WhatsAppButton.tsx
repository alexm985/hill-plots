  ...
  return (
    <div className="fixed bottom-10 right-10 z-[1001] flex items-center">
        <a 
            ...
            className="group relative focus:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] rounded-full focus-visible:ring-offset-2 focus-visible:ring-offset-[#0E1A1A]"
