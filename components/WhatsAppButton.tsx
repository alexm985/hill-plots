  ...
  return (
    <div className="fixed bottom-10 right-10 z-[1001] flex items-center">
        <a 
            ...
            className="group relative focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0E1A1A] outline-none rounded-full"
