    ...
    <div className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-[#0E1A1A]">
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-between px-4 md:px-10 pointer-events-none">
        <button 
          ...
          className="pointer-events-auto w-12 h-12 md:w-16 md:h-16 flex items-center justify-center border border-white/10 text-white/50 hover:text-white hover:border-[#0097b2] hover:bg-[#0097b2]/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0097b2] transition-all duration-300 rounded-full bg-black/10 backdrop-blur-sm group"
        >
